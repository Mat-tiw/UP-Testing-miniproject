...
const params = (0, parameter_reducers_1.startChain)()
    ...
    .addParam(parameter_reducers_1.param.string(['--user'], 'mysqlUser'))
    .addParam(parameter_reducers_1.param.string(['--password'], 'mysqlPassword'))
    .addParam(parameter_reducers_1.param.string(['--db'], 'mysqlDb'));
